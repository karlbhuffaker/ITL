...
<head>
	<title>ICP Tech Lab - ICP Base Install Request</title>
	<meta charset="UTF-8">
...
<form action="/ITL/request" method="post">
	<section>
	<div class="uitkPanel">
		<p>ICP Base Install Request - make your choices and click submit</p>
		<table width="80%">
			<tbody>
			<tr align="center">
			...
			<tr align="center">
				<td align="right">For an ICP base install, select a product release:</td>
				<td align="left">
					<select name="baseInstall" id="baseInstall" required>
						<option value=""></option>
						<%
			...
			<tr align="center">
				<td align="center">Before clicking Submit Request, verify that the VM has the selected DB software installed, that ICP is not installed and the VM is in a state ready for the installation.</td>
			</tr>
			</tbody>
		</table>
	</div>
...
<section>
	...
	<div style="text-align:center;">
		<input type="hidden" id="requestType" name="requestType" value="baseInstall">
