...
<head>
	<title>ICP Tech Lab - DDR KB Install Request</title>
	<meta charset="UTF-8">
...
<form action="/ITL/request" method="post">
	<section>
	<div class="uitkPanel">
		<p>DDR KB Install Request - make your choices and click submit</p>
		<table width="80%">
			<tbody>
			<tr align="center">
			...
			<tr align="center">
				<td align="right">For a DDR KB install, select a KB:</td>
				<td align="left">
			...
			<tr align="center">
				<td align="center">Before clicking Submit Request, verify that DDR is installed and the VM is in a state ready for the installation.</td>
			</tr>
			</tbody>
		</table>
	</div>
...
<section>
	...
	<div style="text-align:center;">
		<input type="hidden" id="requestType" name="requestType" value="ddrKbInstall">
