...
<head>
	<title>ICP Tech Lab - DDR Base Install Request</title>
	<meta charset="UTF-8">
...
<form action="/ITL/request" method="post">
	<section>
	<div class="uitkPanel">
		<p>DDR Base Install Request - make your choices and click submit</p>
		<table width="80%">
			<tbody>
			<tr align="center">
			...
			<tr align="center">
				<td align="right">For a DDR base installation, select a KB:</td>
				<td align="left">
					<select name="kb" id="kb" required>
						<option value=""></option>
						<%
			...
			<tr align="center">
				<td align="right">Select an installed database:</td>
				<td align="left">
					<select name="db" id="db" required>
						<option value=""></option>
						<option value="SQL">SQL Server</option>
						<option value="ORA">Oracle</option>
						<option value="POST" disabled>Postgres</option>
					</select>
				</td>
			</tr>
			<tr align="center">
				<td align="center">Before clicking Submit Request, verify that the VM has the selected DB software installed, that DDR is not installed and the VM is in a state ready for the installation.</td>
			</tr>
			</tbody>
		</table>
	</div>
...
<section>
	...
	<div style="text-align:center;">
		<input type="hidden" id="requestType" name="requestType" value="ddrBaseInstall">
